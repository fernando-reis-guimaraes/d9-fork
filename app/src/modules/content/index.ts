...
const checkForSystem: NavigationGuard = (to, from) => {
	...
	if (to.params.collection === 'sigedin_users') {
	...
	if (to.params.collection === 'sigedin_files') {
		if (to.params.primaryKey) {
	...
	if (to.params.collection === 'sigedin_activity') {
		if (to.params.primaryKey) {
	...
	if (to.params.collection === 'sigedin_webhooks') {
		if (to.params.primaryKey) {
	...
	if (to.params.collection === 'sigedin_presets') {
		if (to.params.primaryKey) {
