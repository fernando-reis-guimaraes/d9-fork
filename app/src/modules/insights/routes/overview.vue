...
export default defineComponent({
	...
	setup() {
		...
		const createAllowed = computed<boolean>(() => {
			return permissionsStore.hasPermission('sigedin_dashboards', 'create');
		});

		const updateAllowed = computed<boolean>(() => {
			return permissionsStore.hasPermission('sigedin_dashboards', 'update');
		});

		const deleteAllowed = computed<boolean>(() => {
			return permissionsStore.hasPermission('sigedin_dashboards', 'delete');
		});
