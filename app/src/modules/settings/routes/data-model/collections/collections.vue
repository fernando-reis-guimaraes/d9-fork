			...
			return translate(
				sortBy(
					collectionsStore.collections.filter(
						(collection) => collection.collection.startsWith('sigedin_') === false && collection.meta
					),
		...
		const tableCollections = computed(() => {
			return translate(
				sortBy(
					collectionsStore.collections.filter(
						(collection) =>
							collection.collection.startsWith('sigedin_') === false &&
			...
			return translate(
				sortBy(
					collectionsStore.collections
						.filter((collection) => collection.collection.startsWith('sigedin_') === true)
