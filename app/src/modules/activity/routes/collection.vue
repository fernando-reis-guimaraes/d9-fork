<template>
	...
	>
		...
		>
			...
			<template #actions>
				<search-input v-model="search" v-model:filter="filter" collection="sigedin_activity" />
			</template>
...
export default defineComponent({
	...
	setup() {
		...
		const { layout, layoutOptions, layoutQuery, filter, search } = usePreset(ref('sigedin_activity'));
