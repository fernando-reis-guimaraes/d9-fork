<template>
	...
	>
		...
		>
			...
			<template #actions>
				<search-input v-model="search" v-model:filter="filter" collection="sigedin_files" />
...
export default defineComponent({
	...
	setup(props) {
		...
		const { layout, layoutOptions, layoutQuery, filter, search, resetPreset } = usePreset(ref('sigedin_files'));
		...
		function usePermissions() {
			const batchEditAllowed = computed(() => {
				...
				const updatePermissions = permissionsStore.permissions.find(
					(permission) => permission.action === 'update' && permission.collection === 'sigedin_files'
				);
			...
			const batchDeleteAllowed = computed(() => {
				...
				const deletePermissions = permissionsStore.permissions.find(
					(permission) => permission.action === 'delete' && permission.collection === 'sigedin_files'
				);
			...
			const createAllowed = computed(() => {
				...
				const createPermissions = permissionsStore.permissions.find(
					(permission) => permission.action === 'create' && permission.collection === 'sigedin_files'
				);
			...
			const createFolderAllowed = computed(() => {
				...
				const createPermissions = permissionsStore.permissions.find(
					(permission) => permission.action === 'create' && permission.collection === 'sigedin_folders'
				);
